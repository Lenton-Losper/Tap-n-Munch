/**
 * Production: apply user_active_context migration (platform-admin vs.
 * restaurant-owner login redirect precedence).
 *
 *   npx tsx scripts/apply-active-context-production.ts
 *
 * Requires linked Supabase CLI auth (SUPABASE_ACCESS_TOKEN) against production.
 * Not run as part of Phase 1 -- staging verification first, production requires sign-off.
 */
import {
...
function main(): void {
  ...
  console.log('APPLY_ACTIVE_CONTEXT_PRODUCTION_OK')
}

/**
 * Staging: apply the stock_transfers/stock_transfer_items RLS OWNER-only fix.
 *   npx tsx scripts/apply-stock-transfers-rls-owner-fix-staging.ts
 */
...
const MIGRATION = 'supabase/migrations/20260719240000_stock_transfers_rls_owner_only.sql'
...
function main(): void {
  ...
  console.log('APPLY_STOCK_TRANSFERS_RLS_OWNER_FIX_STAGING_OK')
}

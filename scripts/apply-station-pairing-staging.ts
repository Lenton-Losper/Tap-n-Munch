/**
 * Staging: apply the terminal station pairing migration (restaurant_terminals.station_kind).
 *   npx tsx scripts/apply-station-pairing-staging.ts
 */
...
const MIGRATION = 'supabase/migrations/20260828230000_terminal_station_pairing.sql'
...
function main(): void {
  ...
  console.log('APPLY_STATION_PAIRING_STAGING_OK')
}

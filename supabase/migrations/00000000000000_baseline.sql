-- Phase 2A baseline: full public schema snapshot from staging reconciliation.
-- Idempotent where possible so a partially-initialized database can be reconciled.
-- Functions/triggers/views use CREATE OR REPLACE; tables/sequences use IF NOT EXISTS.
...
CREATE INDEX IF NOT EXISTS "audit_logs_restaurant_id_idx" ON "public"."audit_logs" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "bug_reports_restaurant_id_idx" ON "public"."bug_reports" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "idx_customer_sessions_active" ON "public"."customer_sessions" USING "btree" ("active");
...
CREATE INDEX IF NOT EXISTS "idx_customer_sessions_tab_id" ON "public"."customer_sessions" USING "btree" ("tab_id");
...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_customer_sessions_token" ON "public"."customer_sessions" USING "btree" ("token");
...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_goods_received_grv_number" ON "public"."goods_received" USING "btree" ("grv_number");
...
CREATE INDEX IF NOT EXISTS "idx_goods_received_invoice" ON "public"."goods_received" USING "btree" ("invoice_number");
...
CREATE INDEX IF NOT EXISTS "idx_goods_received_items_grv" ON "public"."goods_received_items" USING "btree" ("goods_received_id");
...
CREATE INDEX IF NOT EXISTS "idx_goods_received_items_stock_item" ON "public"."goods_received_items" USING "btree" ("stock_item_id");
...
CREATE INDEX IF NOT EXISTS "idx_goods_received_restaurant" ON "public"."goods_received" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "idx_orders_channel" ON "public"."orders" USING "btree" ("channel");
...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_orders_idempotency_key" ON "public"."orders" USING "btree" ("idempotency_key") WHERE ("idempotency_key" IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS "idx_orders_ready_to_pay" ON "public"."orders" USING "btree" ("restaurant_id", "customer_ready_to_pay") WHERE ("customer_ready_to_pay" = true);
...
CREATE INDEX IF NOT EXISTS "idx_payments_restaurant_id" ON "public"."payments" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "idx_payments_tab_id" ON "public"."payments" USING "btree" ("tab_id");
...
CREATE INDEX IF NOT EXISTS "idx_restaurant_tables_kiosk" ON "public"."restaurant_tables" USING "btree" ("restaurant_id", "is_kiosk") WHERE ("is_kiosk" = true);
...
CREATE INDEX IF NOT EXISTS "idx_restaurant_terminals_active" ON "public"."restaurant_terminals" USING "btree" ("active");
...
CREATE INDEX IF NOT EXISTS "idx_restaurant_terminals_device_id" ON "public"."restaurant_terminals" USING "btree" ("device_id");
...
CREATE INDEX IF NOT EXISTS "idx_restaurant_terminals_restaurant_id" ON "public"."restaurant_terminals" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "idx_stock_items_restaurant" ON "public"."stock_items" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "idx_stock_movements_restaurant" ON "public"."stock_movements" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "idx_stock_movements_stock_item" ON "public"."stock_movements" USING "btree" ("stock_item_id");
...
CREATE UNIQUE INDEX IF NOT EXISTS "idx_tabs_one_open_per_table" ON "public"."tabs" USING "btree" ("restaurant_id", "table_number") WHERE ("status" = 'open'::"text");
...
CREATE INDEX IF NOT EXISTS "idx_tabs_status" ON "public"."tabs" USING "btree" ("status");
...
CREATE UNIQUE INDEX IF NOT EXISTS "orders_idempotency_key_unique" ON "public"."orders" USING "btree" ("idempotency_key") WHERE ("idempotency_key" IS NOT NULL);
...
CREATE UNIQUE INDEX IF NOT EXISTS "orders_paycloud_merchant_order_no_unique" ON "public"."orders" USING "btree" ("paycloud_merchant_order_no") WHERE ("paycloud_merchant_order_no" IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS "report_schedules_restaurant_id_idx" ON "public"."report_schedules" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "restaurant_invites_restaurant_id_idx" ON "public"."restaurant_invites" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "restaurant_terminals_activation_code_idx" ON "public"."restaurant_terminals" USING "btree" ("activation_code") WHERE ("activation_code" IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS "restaurant_terminals_refresh_token_hash_idx" ON "public"."restaurant_terminals" USING "btree" ("refresh_token_hash") WHERE ("refresh_token_hash" IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS "restaurant_terminals_restaurant_id_idx" ON "public"."restaurant_terminals" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "staff_invites_restaurant_id_idx" ON "public"."staff_invites" USING "btree" ("restaurant_id");
...
CREATE INDEX IF NOT EXISTS "staff_invites_token_idx" ON "public"."staff_invites" USING "btree" ("token");
...
DROP POLICY IF EXISTS "Allow service update orders" ON "public"."orders";
...
DROP POLICY IF EXISTS "Owners and managers can view inventory movements" ON "public"."inventory_movements";
CREATE POLICY "Owners and managers can view inventory movements" ON "public"."inventory_movements" FOR SELECT USING ((EXISTS ( SELECT 1 FROM "public"."restaurant_users" "ru" WHERE (("ru"."user_id" = "auth"."uid"()) AND ("ru"."restaurant_id" = "inventory_movements"."restaurant_id") AND ("ru"."role" = ANY (ARRAY['owner'::"text", 'manager'::"text"]))))));
...
DROP POLICY IF EXISTS "Owners can manage features" ON "public"."restaurant_features";
CREATE POLICY "Owners can manage features" ON "public"."restaurant_features" USING ((EXISTS ( SELECT 1 FROM "public"."restaurant_users" "ru" WHERE (("ru"."user_id" = "auth"."uid"()) AND ("ru"."restaurant_id" = "restaurant_features"."restaurant_id") AND ("ru"."role" = 'owner'::"text")))));
...
DROP POLICY IF EXISTS "Owners can manage invites" ON "public"."staff_invites";
CREATE POLICY "Owners can manage invites" ON "public"."staff_invites" USING ((EXISTS ( SELECT 1 FROM "public"."restaurant_users" "ru" WHERE (("ru"."user_id" = "auth"."uid"()) AND ("ru"."restaurant_id" = "staff_invites"."restaurant_id") AND ("ru"."role" = 'owner'::"text")))));
...
CREATE POLICY "Owners can manage own restaurant goods received items" ON "public"."goods_received_items" USING (("goods_received_id" IN ( SELECT "goods_received"."id" FROM "public"."goods_received" WHERE ("goods_received"."restaurant_id" IN ( SELECT "public"."user_restaurant_ids"() AS "user_restaurant_ids"))))) WITH CHECK (("goods_received_id" IN ( SELECT "goods_received"."id" FROM "public"."goods_received" WHERE ("goods_received"."restaurant_id" IN ( SELECT "public"."user_restaurant_ids"() AS "user_restaurant_ids")))));
...
DROP POLICY IF EXISTS "Owners can manage terminals" ON "public"."restaurant_terminals";
CREATE POLICY "Owners can manage terminals" ON "public"."restaurant_terminals" USING ((EXISTS ( SELECT 1 FROM "public"."restaurant_users" "ru" WHERE (("ru"."user_id" = "auth"."uid"()) AND ("ru"."restaurant_id" = "restaurant_terminals"."restaurant_id") AND ("ru"."role" = 'owner'::"text")))));
...
DROP POLICY IF EXISTS "Owners can manage their report schedules" ON "public"."report_schedules";
CREATE POLICY "Owners can manage their report schedules" ON "public"."report_schedules" USING ((EXISTS ( SELECT 1 FROM "public"."restaurants" WHERE (("restaurants"."id" = "report_schedules"."restaurant_id") AND ("restaurants"."owner_id" = "auth"."uid"())))));
...
DROP POLICY IF EXISTS "Owners can manage their settings" ON "public"."restaurant_settings";
CREATE POLICY "Owners can manage their settings" ON "public"."restaurant_settings" USING ((EXISTS ( SELECT 1 FROM "public"."restaurant_users" "ru" WHERE (("ru"."user_id" = "auth"."uid"()) AND ("ru"."restaurant_id" = "restaurant_settings"."restaurant_id") AND ("ru"."role" = 'owner'::"text")))));
...
CREATE POLICY "Owners can read own restaurant invites" ON "public"."restaurant_invites" FOR SELECT USING (("restaurant_id" IN ( SELECT "restaurant_users"."restaurant_id" FROM "public"."restaurant_users" WHERE ("restaurant_users"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Owners can read own restaurant setup status" ON "public"."restaurant_setup_status" FOR SELECT USING (("restaurant_id" IN ( SELECT "restaurant_users"."restaurant_id" FROM "public"."restaurant_users" WHERE ("restaurant_users"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Owners can read own restaurant terminals" ON "public"."restaurant_terminals" FOR SELECT USING (("restaurant_id" IN ( SELECT "restaurant_users"."restaurant_id" FROM "public"."restaurant_users" WHERE ("restaurant_users"."user_id" = "auth"."uid"()))));
...
DROP POLICY IF EXISTS "Owners can read own setup status" ON "public"."restaurant_setup_status";
CREATE POLICY "Owners can read own setup status" ON "public"."restaurant_setup_status" FOR SELECT USING ((EXISTS ( SELECT 1 FROM "public"."restaurant_users" "ru" WHERE (("ru"."user_id" = "auth"."uid"()) AND ("ru"."restaurant_id" = "restaurant_setup_status"."restaurant_id") AND ("ru"."role" = 'owner'::"text")))));
...
CREATE POLICY "Owners can read own staff invites" ON "public"."staff_invites" FOR SELECT USING (("restaurant_id" IN ( SELECT "restaurant_users"."restaurant_id" FROM "public"."restaurant_users" WHERE ("restaurant_users"."user_id" = "auth"."uid"()))));
...
DROP POLICY IF EXISTS "Owners can read their report send logs" ON "public"."report_send_log";
CREATE POLICY "Owners can read their report send logs" ON "public"."report_send_log" FOR SELECT USING ((EXISTS ( SELECT 1 FROM "public"."restaurants" WHERE (("restaurants"."id" = "report_send_log"."restaurant_id") AND ("restaurants"."owner_id" = "auth"."uid"())))));
...
CREATE POLICY "Owners can read their subscription" ON "public"."subscriptions" FOR SELECT USING ((EXISTS ( SELECT 1 FROM "public"."restaurant_users" "ru" WHERE (("ru"."user_id" = "auth"."uid"()) AND ("ru"."restaurant_id" = "subscriptions"."restaurant_id")))));
...
CREATE POLICY "Owners can update own restaurant setup status" ON "public"."restaurant_setup_status" FOR UPDATE USING (("restaurant_id" IN ( SELECT "restaurant_users"."restaurant_id" FROM "public"."restaurant_users" WHERE ("restaurant_users"."user_id" = "auth"."uid"()))));
...
DROP POLICY IF EXISTS "Owners can update own setup status" ON "public"."restaurant_setup_status";
CREATE POLICY "Owners can update own setup status" ON "public"."restaurant_setup_status" FOR UPDATE USING ((EXISTS ( SELECT 1 FROM "public"."restaurant_users" "ru" WHERE (("ru"."user_id" = "auth"."uid"()) AND ("ru"."restaurant_id" = "restaurant_setup_status"."restaurant_id") AND ("ru"."role" = 'owner'::"text")))));
...
DROP POLICY IF EXISTS "Platform admins can read audit logs" ON "public"."platform_audit_logs";
CREATE POLICY "Platform admins can read audit logs" ON "public"."platform_audit_logs" FOR SELECT USING ((EXISTS ( SELECT 1 FROM "public"."platform_admins" WHERE ("platform_admins"."user_id" = "auth"."uid"()))));
...
DROP POLICY IF EXISTS "Public can read features" ON "public"."restaurant_features";
...
DROP POLICY IF EXISTS "Public can read menu subcategories" ON "public"."menu_subcategories";
...
CREATE POLICY "Staff can read orders for their restaurant" ON "public"."orders" FOR SELECT TO "authenticated" USING (("restaurant_id" IN ( SELECT "staff_members"."restaurant_id" FROM "public"."staff_members" WHERE (("staff_members"."email" = ("auth"."jwt"() ->> 'email'::"text")) AND ("staff_members"."active" = true)))));
...
CREATE POLICY "Staff can read own permissions" ON "public"."staff_permissions" FOR SELECT TO "authenticated" USING (("staff_id" IN ( SELECT "staff_members"."id" FROM "public"."staff_members" WHERE ("staff_members"."email" = ("auth"."jwt"() ->> 'email'::"text")))));
...
CREATE POLICY "Staff can update orders for their restaurant" ON "public"."orders" FOR UPDATE TO "authenticated" USING (("restaurant_id" IN ( SELECT "staff_members"."restaurant_id" FROM "public"."staff_members" WHERE (("staff_members"."email" = ("auth"."jwt"() ->> 'email'::"text")) AND ("staff_members"."active" = true))))) WITH CHECK (("restaurant_id" IN ( SELECT "staff_members"."restaurant_id" FROM "public"."staff_members" WHERE (("staff_members"."email" = ("auth"."jwt"() ->> 'email'::"text")) AND ("staff_members"."active" = true)))));
...
DROP POLICY IF EXISTS "Staff can update own push token" ON "public"."staff_members";
...
CREATE POLICY "Users can read own restaurant" ON "public"."restaurants" FOR SELECT USING (("id" IN ( SELECT "users"."restaurant_id" FROM "public"."users" WHERE ("users"."id" = "auth"."uid"()))));
...
DROP POLICY IF EXISTS "Users can read own restaurant_users row" ON "public"."restaurant_users";
...
CREATE POLICY "bug_reports_insert_own_restaurant" ON "public"."bug_reports" FOR INSERT TO "authenticated" WITH CHECK (("restaurant_id" IN ( SELECT "users"."restaurant_id" FROM "public"."users" WHERE ("users"."id" = "auth"."uid"()))));
...
CREATE POLICY "bug_reports_select_own_restaurant" ON "public"."bug_reports" FOR SELECT TO "authenticated" USING (("restaurant_id" IN ( SELECT "users"."restaurant_id" FROM "public"."users" WHERE ("users"."id" = "auth"."uid"()))));
